...
$(window).on('load', function () {
    ...
    var swiper3 = new Swiper(".movieposter", {
        effect: "coverflow",
        grabCursor: true,
        centeredSlides: true,
        slidesPerView: "auto",
    ...
    /* chair selection theater  */
    var container = document.querySelector('.seatwrap');
    var chairs = document.querySelectorAll('.row .chair:not(.occupied)');
    ...
    function updateSelectedCount() {
        const selectedchairs = document.querySelectorAll('.linerow .chair.selected');
        const selectedchairsCount = selectedchairs.length;
        count.innerText = selectedchairsCount;
        total.value = selectedchairsCount * ticketPrice;
    }
