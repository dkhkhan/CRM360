...
*/
    ...
    var areachartred = document
        .getElementById("areachartred1")
        .getContext("2d");
    ...
    var areachartgreen = document
        .getElementById("areachartgreen1")
        .getContext("2d");
    ...
    var areachartyellow = document
        .getElementById("areachartyellow1")
        .getContext("2d");
    ...
    var areachartmediumgreen = document
        .getElementById("mediumchartgreen1")
        .getContext("2d");
    var gradientmediumgreen = areachartmediumgreen.createLinearGradient(
        0,
        0,
        0,
        150
    ...
    var myAreaChartmediumgreen = new Chart(
        areachartmediumgreen,
        myareachartmediumgreenConfig
    );
    /* my area chart randomize */
    setInterval(function () {
    ...
    var areachartmediumred = document
        .getElementById("mediumchartred1")
        .getContext("2d");
    var gradientmediumred = areachartmediumred.createLinearGradient(
        0,
        0,
        0,
        150
    ...
    var myAreaChartmediumred = new Chart(
        areachartmediumred,
        myareachartmediumredConfig
    );
    /* my area chart randomize */
    setInterval(function () {
...
*/
    ...
    $(".chosenoptgroup").on("change", function (event, el) {
        var textdisplay_element = $(
            ".chosenoptgroup + .chosen-container .chosen-single > span"
        );
        var selected_element = $(".chosenoptgroup option:selected");
        var selected_value = selected_element.val();
        if (selected_element.closest("optgroup").length > 0) {
            var parent_optgroup = selected_element
                .closest("optgroup")
                .attr("label");
            textdisplay_element
                .text(parent_optgroup + " " + selected_value)
