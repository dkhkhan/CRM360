    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <div class="card border-0 mb-4 px-2">
                    <div class="card-header mb-4">
                        <h5 class="title">Country To Role</h5>
                    </div>
                    <div class="card-body p-0">
                       
                        <form action="{{ route('roleCountry.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-12 col-md-12">
                                    <div class="row checkall">
                                        ...
                                        <div class="col-4">
                                            <div class="form-check">
                                                <input class="form-check-input" name="role_countries[]" type="checkbox" value="{{ $country->id }}" id="{{$country->country_name.'_'.$country->id}}">
                                ...
                                <div class="col-12 col-md-12 mt-4">
                                    <button class="btn btn-theme bg-green" type="submit">Submit</button>
                                </div>
                            </div>
                        </form> 
                    </div>
