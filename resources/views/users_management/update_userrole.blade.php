                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-auto align-self-center">
                                        <h6 class="fw-medium mb-0">User Roles</h6>
                                        <p class="text-secondary small">All Roles</p>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <td>
                                                <?php 
                                                    ...
                                                    if($role->show_log == 0)
                                                        $class = 'bg-red';    
                                                ?>
                                                <span class="badge badge-sm {{ $class }}">{{ ($role->show_log == 1) ? 'Yes' : 'No' }}</span></td>
                                            <td>
                                               <a href="{{ route('userRole.edit',$role->id) }}" class="btn btn-theme"><i class="bi bi-pencil-square"></i></a>
            ...
            <div class="col-12 col-md-4">
                <div class="card border-0 mb-4 px-2">
                    <div class="card-header mb-4">
                        <h5 class="title">Update New Role</h5>
                    </div>
                    <div class="card-body p-0">
                        <form action="{{route('userRole.update',$selectedRole->id)}}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <div class="col-12 col-md-12 mb-md-0  was-validated">
                                        ...
                                        <div class="form-group mb-3 position-relative check-valid @if(!$errors->any())is-valid @endif">
                                            <div class="input-group input-group-lg">
                                                ...
                                                <div class="form-floating">
                                                    <input type="text" placeholder="Enter Role" value="{{ old('role_name',$selectedRole->role_name) }}" name="role_name" class="form-control border-start-0">
                                    ...
                                    <div class="form-check form-switch mb-4">
                                        <input class="form-check-input" type="checkbox" role="switch" id="showlogs" name="showlogs" @if($selectedRole->show_log == 1) checked="checked" @endif>
                                        <label class="form-check-label" for="showlogs">Show Logs</label>
                                    </div>
                                    <button class="btn btn-theme" type="submit">Update Role</button>
                                </div>
                            </div>
                        </form> 
                    </div>
