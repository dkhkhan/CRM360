            ...
            <div class="col-12 col-md-4">
                <div class="card border-0 mb-4 px-2">
                    <div class="card-header mb-4">
                        <h5 class="title">Add New Country</h5>
                    </div>
                    <div class="card-body p-0">
                        <form action="{{route('userCountry.store')}}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-12 col-md-12 mb-md-0  was-validated">
                                        ...
                                        <div class="form-group mb-3 position-relative check-valid @if(!$errors->any())is-valid @endif">
                                            <div class="input-group input-group-lg">
                                                ...
                                                <div class="form-floating">
                                                    <input type="text" placeholder="Enter Country" value="{{ old('country_name') }}" name="country_name" class="form-control border-start-0">
                                    ...
                                    <button class="btn btn-theme" type="submit">Add New Country</button>
                                </div>
                            </div>
                        </form> 
                    </div>
