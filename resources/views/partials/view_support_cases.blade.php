<?php
    ...
    $kpi_failed                   = ( isset($all_kpi['Failed']) && array_key_exists('Failed',$all_kpi) ) ? $all_kpi['Failed'] : 0;
    $kpi_near_sla_breach          = ( isset($all_kpi['Nearing SLA Breach']) && array_key_exists('Nearing SLA Breach',$all_kpi) ) ? $all_kpi['Nearing SLA Breach'] : 0;
    ...
    $kpi_near_sla_brach_percentag = ( $total_kpi > 0 && $kpi_near_sla_breach > 0 ) ? number_format( $kpi_near_sla_breach/$total_kpi * 100 ) : 0;
    $kpi_in_progress_percentag    = ( $total_kpi > 0 && $kpi_in_progress ) ? number_format( $kpi_in_progress/$total_kpi * 100 ) : 0;
