                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col">
                            ...
                            <p class="text-success"><a href="" class="resolved_cases">{{ $succeeded }}</a></p>
                        </div>
                        <div class="col border-left-dashed">
                            <p class="text-secondary small mb-1">In Progress</p>
                            <p class="text-warning"><a href="" class="in_progress_cases">{{ $in_progress_total }}</a></p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <p class="my-title-text-animation">
                                    <a href="" class="nearing_sla_breach">{{ $near_sla }}<small class="text-secondary small mb-1"> Cases</small></a></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col">
                                ...
                                <p class="my-title-text-animation">
                                    <a href="" class="failed_cases">{{ $expired }}<small class="text-secondary small mb-1"> Cases</small></a></p>
                            </div>
                        </div>
                    </div>
                </div>
