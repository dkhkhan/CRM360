                                    ...
                                    <div class="row">
                                        <div class="col-auto align-self-center">
                                            <figure class="avatar avatar-40 rounded-circle coverimg vm">
                                                <img src="{{ asset('assets/img/user-profile-crm360.png') }}" alt="" id="userphotoonboarding2" />
                                            </figure>
                                        </div>
                                        <div class="col ps-0 align-self-center d-none d-lg-block">
                                            <p class="mb-0">
                                                <span class="text-dark username">{{ Auth::user()->name }}</span><br>
                                                <small class="small">{{ Auth::user()->country }}</small>
                                            </p>
                                        </div>
                                        <div class="col ps-0 align-self-center d-none d-lg-block">
                                        ...
                                        <div class="row">
                                            <div class="col-auto">
                                                <figure class="avatar avatar-50 rounded-circle coverimg vm">
                                                    <img src="{{ asset('assets/img/user-profile-crm360.png') }}" alt="" id="userphotoonboarding3" />
                                                </figure>
                                            </div>
                                            <div class="col align-self-center ps-0">
                                                <h6 class="mb-0"><span class="username">{{ Auth::user()->name }}</span></h6>
                                                <h7 class="mt-5"><span class="username">{{ Auth::user()->job_title }}</span></h7>
                                            </div>
                                        </div>
                                    </div>
